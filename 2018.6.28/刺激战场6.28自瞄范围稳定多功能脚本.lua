...
mima = "1039227140"
v_value = gg.prompt({
  "百度6.28刺激战场亲测稳定变态功能，本脚本免费脚本如果你是购买的证明你被骗了，祝你游戏愉快。"
}, {
  [1] = 0
}, {
  [1] = "number"
...
gg.alert("密码正确 百度6.28刺激战场稳定变态功能 此脚本为免费脚本")
gg.alert("是挂3分毒，部分手机封号不是我的脚本不稳。而是腾讯检测针对部分手机，还请口下留情")
gg.alert(" 百度永久更新https://github.com/jia110/Stimulate-the-battlefield")
function  Main()
menu1 = gg.choice({
      "吉普加速和下水",
       "透视上色",
...
gg.toast("50%")
gg.clearResults() gg.searchNumber("8;0.00999999978::", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
gg.searchNumber("8", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
gg.getResults(30)
gg.editAll("10.90734863281", gg.TYPE_FLOAT)
gg.clearResults()
gg.toast("全局加速恢复成功 无效再开一次")
end
...
function i()
gg.searchNumber("1;3.951661669396e-43;1;1;2;1.4012984643248e-45::", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
gg.searchNumber("1", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
gg.getResults(94)
...
gg.clearResults()
gg.setRanges(32)
gg.searchNumber("15;28;200;26;200;200",16,false,536870912,0,-1)
gg.searchNumber("15;26;28",16,false,536870912,0,-1)
gg.getResults(54)
gg.editAll("-200",16)
gg.toast("开镜锁头开启成功")
gg.clearResults()
...
function Exit()
print("百度团队为您倾情打造 百度永久更新https://github.com/jia110/Stimulate-the-battlefield")
os.exit()
end
cs= "百度"
while true do
