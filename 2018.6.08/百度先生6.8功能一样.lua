...
function ZYM()
    zjm = gg.choice({"进入", "退出"}, nil, "百度先生QQ1039227140 ")
    if zjm == 1 then
        CJZC()
    end
    if zjm == 2 then
...
function CJZC()
    cjgn =
        ...
        {
            "–·↓落地功能↓·–",
            "百度先生QQ1039227140  落地透视",
            "百度先生QQ1039227140  流畅紫人",
            "百度先生QQ1039227140  流畅红人",
            "百度先生QQ1039227140  倍镜除草",
            "–·↓娱乐功能↓·–",
            "百度先生QQ1039227140  吉普加速",
            "百度先生QQ1039227140  吉普下水",
            "百度先生QQ1039227140  蹦蹦上天",
            "百度先生QQ1039227140  载聚上色",
            "–·↓地图特效↓·–",
            "百度先生QQ1039227140  黑夜模式",
            "百度先生QQ1039227140  樱花特效",
            "百度先生QQ1039227140  黑色地皮",
            "百度先生QQ1039227140  雪地特效",
            "–·↓测试功能↓·–",
            "百度先生QQ1039227140  人物天线",
            "百度先生QQ1039227140  高倍锁头",
            "百度先生QQ1039227140  半倍无后",
            "百度先生QQ1039227140  范围打击",
            "百度先生QQ1039227140  射速页面",
            "–·↓功能介绍↓·–",
            "透视上色  落地红B",
            "娱乐功能  上车红B",
            "地图特效  落地红B",
        ...
        nil,
        "百度先生QQ1039227140 自动过保护 范围打击大厅开"
    )
    if cjgn == 1 then
        z()
    end
    ...
    function z()
        ...
        gg.toast("过保护30％  百度先生QQ1039227140 ")
        gg.searchNumber("1", gg.TYPE_AUTO, false, gg.SIGN_EQUAL, 0, -1)
        gg.toast("过保护50％")
        gg.searchNumber("1", gg.TYPE_AUTO, false, gg.SIGN_EQUAL, 0, -1)
        gg.toast("过保护70％  百度先生QQ1039227140 ")
        gg.clearResults()
        gg.searchNumber("1", gg.TYPE_AUTO, false, gg.SIGN_EQUAL, 0, -1)
...
function o()
    ...
    gg.setRanges(gg.REGION_BAD)
    gg.searchNumber(
        "1.0761972e-42;1.1180837e-19;1.1183813e-19;2.3802076e21;3.4907095e-29",
        gg.TYPE_FLOAT,
        false,
        gg.SIGN_EQUAL,
        0,
...
function q()
    ssgn =
        gg.choice(
        {
            "百度先生QQ1039227140  sc  1.5倍射速",
            "百度先生QQ1039227140  m4 1.5倍射速",
            "百度先生QQ1039227140  AK  1.5倍射速",
            "百度先生QQ1039227140  返回上一页"
        },
        nil,
        " 最稳射速 加油吃鸡！"
    )
