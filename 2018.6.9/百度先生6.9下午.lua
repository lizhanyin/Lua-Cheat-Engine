...
v_value=gg.prompt({'请输入密码(百度先QQ1039227140)'},{[1]=0},{[1]='number'});
...
function Main() 
 ...
 ' 开镜锁头（落地开）',
  ...
  '跳墙 (落地开启)',
   ...
   nil,'百度先生提示:百度先生内部群6.9功能稳定强大')
  if menu1 == 1 then b() end
   if menu1 == 2 then g() end
   if menu1 == 3 then f() end
 if menu1 == 4 then l() end
  if menu1 == 5 then o() end
    if menu1 == 6 then k() end
     if menu1 == 7 then p() end
        if menu1 == 8 then q() end
      if menu1 == 9 then a1() end
    if menu1 == 10 then a2() end
    if menu1 == 11 then a3() end
      if menu1 == 12 then a4() end
    if menu1 == 13 then a5() end
      if menu1 == 14 then a6() end
    if menu1 == 15 then a7() end
       if menu1 == 16 then a8() end
    if menu1 == 17  then a9() end
      if menu1 == 18 then a10() end
    if menu1 == 19 then a11() end
      if menu1 == 20 then a12() end
       if menu1 ==21 then a30() end
        if menu1 == 22 then a13() end
         if menu1 == 23 then a14() end
           if menu1 == 24 then a15() end
             if menu1 == 25 then a16() end
              if menu1 == 26 then a17() end
                if menu1 == 27 then e() end
  XGCK=-1
end
-----------------------------------------------------------------
function a16()
...
function a3()
 gg.clearResults() gg.searchNumber("32,769;-2,134,900,722", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1) 
gg.searchNumber("32769", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1) gg.toast("50%") 
gg.getResults(100) 
gg.editAll("10", gg.TYPE_DWORD) gg.clearResults() 
gg.toast("人物荧光绿开启成功") 
...
gg.searchNumber("1;479.5;150;100;3;1", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
gg.searchNumber("479.5", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
gg.getResults(1000)
gg.editAll("900", gg.TYPE_FLOAT)
gg.toast("跳远 后退加速开启成功")
